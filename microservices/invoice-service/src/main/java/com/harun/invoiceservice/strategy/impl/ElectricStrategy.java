...
@Component("electricStrategy")
@RequiredArgsConstructor
public class ElectricStrategy implements PayStrategy {
    private static final Logger logger = LoggerFactory.getLogger(ElectricStrategy.class);
